def get_optimizer_parameters_with_llrd(model, peak_lr, multiplicative_factor):
    ...
    tsl_parameters = [{'params': [param for name, param in model.task_specific_layer.named_parameters()],
    ...
    encoder_parameters = [{'params': [param for name, param in layer.named_parameters()],
    ...
    embedding_parameters = [{'params': [param for name, param in model.transformer.embeddings.named_parameters()],
